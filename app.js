...
// var b = a.length;
// document.write("my favorite mobile model is:" + " "+ a + "<br>")
...
//  var a = ["cookie","apple pie","cake","chips","patties"]
// var b =prompt("welcome to ABC bakery,what you want to order sir/mam")
// var c = b.toLowerCase();
// for( i = 0 ; i<=a.length ; i++){
//    if ( c === a[i]){
//        document.write( c + " is avaliable at index"+" " +i+ " " + "in our bakery"   )
//        break
//    }
//    else if (c !== a[i]) {
//        document.write("not avaliable")
//        break
//    }
